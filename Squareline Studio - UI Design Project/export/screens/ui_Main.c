...
void ui_Main_screen_init(void)
{
    ...
    ui_Unit_Litres = lv_label_create(ui_Main);
    lv_obj_set_width(ui_Unit_Litres, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Unit_Litres, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Unit_Litres, -13);
    lv_obj_set_y(ui_Unit_Litres, 58);
    lv_obj_set_align(ui_Unit_Litres, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Unit_Litres, "Litres");
    lv_obj_set_style_text_color(ui_Unit_Litres, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Unit_Litres, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_slider_set_value(ui_Slider_Extract, 735, LV_ANIM_OFF);
    ...
    lv_slider_set_value(ui_Slider_Fill, 500, LV_ANIM_OFF);
    ...
    ui_Group_Battery_Percent = lv_obj_create(ui_Main);
    ...
    lv_obj_set_style_text_color(ui_Label_Oil_Change, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_Oil_Change, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_Oil_Change, &ui_font_Small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Group_Driving = lv_obj_create(ui_Main);
    ...
    lv_label_set_text(ui_Label_Driving_Information, "Oil Change Information");
    ...
    ui_Group_Voltage = lv_obj_create(ui_Group_Content);
    lv_obj_set_width(ui_Group_Voltage, 80);
    lv_obj_set_height(ui_Group_Voltage, 40);
    lv_obj_set_align(ui_Group_Voltage, LV_ALIGN_TOP_RIGHT);
    lv_obj_clear_flag(ui_Group_Voltage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Group_Voltage, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Group_Voltage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_Group_Voltage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_Group_Voltage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_Group_Voltage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_Group_Voltage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_LabeL_Battery = lv_label_create(ui_Group_Voltage);
    ...
    lv_obj_set_style_text_color(ui_LabeL_Battery, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(ui_Label_volts, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_volts, -20);
    lv_obj_set_y(ui_Label_volts, -5);
    lv_obj_set_align(ui_Label_volts, LV_ALIGN_BOTTOM_RIGHT);
    lv_label_set_text(ui_Label_volts, "V");
    lv_obj_set_style_text_color(ui_Label_volts, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_volts, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_volts, &ui_font_Small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Label_Oil = lv_label_create(ui_Group_Trip);
    lv_obj_set_width(ui_Label_Oil, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Oil, LV_SIZE_CONTENT);    /// 1
    lv_label_set_text(ui_Label_Oil, "Oil Temp");
    lv_obj_set_style_text_color(ui_Label_Oil, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(ui_Label_unit, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_unit, -20);
    lv_obj_set_y(ui_Label_unit, -5);
    lv_obj_set_align(ui_Label_unit, LV_ALIGN_BOTTOM_RIGHT);
    lv_label_set_text(ui_Label_unit, "°C");
    lv_obj_set_style_text_color(ui_Label_unit, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_unit, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_unit, &ui_font_Small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Label_Filled = lv_label_create(ui_Group_Max_Speed);
    ...
    lv_label_set_text(ui_Label_AVG_Speed, "EXTRACTED");
